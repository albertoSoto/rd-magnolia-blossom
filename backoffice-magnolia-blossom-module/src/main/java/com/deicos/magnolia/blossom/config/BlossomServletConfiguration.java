...
@Configuration
@ComponentScan(
        basePackages = {"com.deicos.magnolia.blossom"},
        includeFilters = {
...
@Import({JspRenderingConfiguration.class, SiteAwareFreemarkerRenderingConfiguration.class,BackofficeMvcConfig.class})
public class BlossomServletConfiguration {
    ...
    /**
     * Handler adapter for Controller interface style controller. Required because these are used internally by the
