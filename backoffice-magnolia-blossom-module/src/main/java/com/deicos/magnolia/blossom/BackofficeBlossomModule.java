package com.deicos.magnolia.blossom;
...
/**
 * This class manages the lifecycle of the backoffice-magnolia module. It starts and stops Spring when Magnolia starts up and
 ...
 */
public class BackofficeBlossomModule extends BlossomModuleSupport implements ModuleLifecycle {

    public void start(ModuleLifecycleContext moduleLifecycleContext) {
        if (moduleLifecycleContext.getPhase() == ModuleLifecycleContext.PHASE_SYSTEM_STARTUP) {

            // Using Spring java config
            super.initRootWebApplicationContext(com.deicos.magnolia.blossom.config.BackofficeBlossomModuleConfiguration.class);
            super.initBlossomDispatcherServlet("blossom", com.deicos.magnolia.blossom.config.BlossomServletConfiguration.class);
