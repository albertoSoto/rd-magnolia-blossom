package com.deicos.magnolia.blossom.setup;
 ...
 */
public class BackofficeBlossomModuleVersionHandler extends DefaultModuleVersionHandler {
//add delta task to RegisterModuleServletsTask
}