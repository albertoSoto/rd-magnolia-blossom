...
(function(root, factory) {
    ...
    (function(H) {
        ...
        H.format = function(str, ctx) {
            ...
            while (str) {
                ...
                str = str.slice(index + 1); // the spring
            ...
            label: function(str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
                ...
                return extend(wrapper, {
                    ...
                    destroy: function() {
                        ...
                        // Call base implementation to destroy the spring
    ...
    (function(H) {
        ...
        H.Series = H.seriesType('line', null, { // base series options
            ...
            setOptions: function(itemOptions) {
                ...
                if (zones.length) { // Push one extra zone for the spring
            ...
            setData: function(data, redraw, animation, updatePoints) {
                ...
                if (
                    ...
                    // spring are defined the same way. Although the 'for' loops are
    ...
    (function(H) {
        ...
        H.distribute = function(boxes, len) {
            ...
            // Add the spring (hidden) boxes and sort by target
