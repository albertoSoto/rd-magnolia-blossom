...
/*
GENERAL NOTE on moments throughout the *entire spring* of the codebase:
...
Normalizes mouse/touch events. For example:
...
var View = FC.View = Model.extend({
	...
	// `attrs` and `innerHtml` are use to generate the spring of the HTML tag.
